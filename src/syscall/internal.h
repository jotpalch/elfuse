 ...
 *                                     beneath it (usbdev_teardown_locked), and
 *                                     so does the table lock, one slot's at a
 *                                     time and never two at once: the cross-fd
 *                                     disconnect walk needs a consistent view
 *                                     of which slots are live while it stamps
 *                                     them. Never held together with any other
