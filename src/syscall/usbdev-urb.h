...
/* proc_do_submiturb's first gate (devio.c:1644-1650), in the kernel's order:
 ...
 * zero-length packet (darwin_usb.c:3204-3218, libusb commit 2611713a). ep0 is
 * excluded because the control transfer carries its own status stage.
 */
