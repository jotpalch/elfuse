                                              ...
                                              int *err_out)
{
    *err_out = 0;
     ...
     * written into norm, which the /sys arm below would use for its own folded
     * suffix -- the two never both run -- and classify_path's sys_suffix_out is
     * only set on the /sys arm, so it keeps pointing into live storage either
     * way.
     *
