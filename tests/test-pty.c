...
int main(void)
{
     ...
     */
    {
        ...
        if (sm >= 0 && ioctl(sm, TIOCGPTN, &sn) == 0 &&
            ...
            EXPECT_ERRNO(ioctl(sl, TCFLSH, 3), EINVAL, "TCFLSH(3)");
            ...
            int sbits = 0;
            EXPECT_ERRNO(ioctl(sl, TIOCMGET, &sbits), ENOTTY, "TIOCMGET");
            ...
            EXPECT_ERRNO(ioctl(sl, TIOCMBIS, &sbits), ENOTTY, "TIOCMBIS");
